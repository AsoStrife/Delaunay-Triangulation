...
/**
  http://www.clifford.at/blog/index.php?/archives/132-C++11-stdunordered_set-and-stdunordered_map-are-slower-than-a-naive-implementation.html
  My hashlib::dict<> is a replacement for std::unordered_map<> and my hashlib::pool<> is a replacement for std::unordered_set<>.
  */

#ifndef COMMON_MODULE_HASHLIB_H
#define COMMON_MODULE_HASHLIB_H
